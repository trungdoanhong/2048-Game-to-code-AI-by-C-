...
public:
	...
	Game_AI( ) : score( 0 ), plus( 0 ), win( 2048 ), maxScore( 0 ), response( 0 ), apocalypse( 1 ), isChange(true) {}
...
int main( )
{
	...
	while( 1 )
	{
		...
		if( counter - lastCounter > 200 )
		{
			// AI code here
			// using exec.grid[i][j] to know current display
...
void Game_AI::key_press( char key )
{
...
void Game_AI::game_end_check( Game *screen )
{
	...
	if( response == -1 )
	{
		cout << "\n\n\t\t            > Thank you for playing. "
			<< "\n\n\n\t\t  DEVELOPED BY SCM. Edit by TrungDoanHong [-_-] \n\n";
		press_enter = getchar( );
		exit( 0 );
	}
	control = 0;
...
void Game::display_grid( )
{
	...
	cout << "\n  ::[  THE 2048 PUZZLE  ]::\t Developed by SCM. Edit by TrungDoanHong [-_-]\n\n\t";
